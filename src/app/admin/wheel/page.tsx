  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="animate-fade-in-up flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-black text-foreground mb-1">Wheel Games</h1>
          <p className="text-muted font-medium">
            Pay-per-spin instant win games shown on the public /instawin page.
          </p>
        </div>
        <Link
          href="/admin/wheel/new"
              ...
              {games.length === 0 ? (
                <tr>
                  <td colSpan={6} className="px-5 py-8 text-center text-sm text-muted">
                    No wheel games yet. Create one to list it on the public /instawin page.
                  </td>
                </tr>
              ) : (
                games.map((game) => (
