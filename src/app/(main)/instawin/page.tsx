    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
      <div className="animate-fade-in-up mb-10 text-center">
        ...
        <h1 className="text-3xl sm:text-4xl font-black text-foreground mb-2">
          Spin the Wheel, Win Instantly
        </h1>
        <p className="text-muted text-lg font-medium max-w-2xl mx-auto">
          Pay a small fee to spin. No tickets, no waiting for a draw &mdash; every spin gives you an instant result.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          ...
          <h3 className="text-xl font-bold text-foreground mb-2">No Wheel Games Yet</h3>
          <p className="text-muted font-medium">Check back soon, new wheel games are added regularly.</p>
        </div>
      )}
    </div>
  );
